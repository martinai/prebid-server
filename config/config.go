...
func (cfg *Configuration) setDerivedDefaults() {
	...
	setDefaultUsersync(cfg.Adapters, openrtb_ext.BidderMartinai, "https://ad.liftsvr.com/sync?redirect_url="+url.QueryEscape(externalURL)+"%2Fsetuid%3Fbidder%3Dmartinai%26gdpr%3D{{.GDPR}}%26gdpr_consent%3D{{.GDPRConsent}}%26uid%3D%24%24MARTIN_AI_ID%24%24")
...
func SetupViper(v *viper.Viper, filename string) {
	...
	v.SetDefault("adapters.martinai.endpoint", "https://east.martin.ai/bid/prebid")
